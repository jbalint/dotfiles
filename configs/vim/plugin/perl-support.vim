...
if has("win32")
		let s:Perl_CodeSnippets            = $USERPROFILE.'/vimfiles/codesnippets-perl'
		let s:Perl_Template_Directory      = $USERPROFILE.'/vimfiles/plugin/templates/'
		let	s:Perl_PerlModuleList          = $USERPROFILE.'/vimfiles/plugin/perl-modules.list'
else
